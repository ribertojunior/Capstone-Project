...
public class ProfileActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this)
                .load(bundle.getString(LoginActivity.EXTRA_PHOTO))
                .error(R.drawable.logo)
                .into(profile);

        TextView textView = (TextView) header.findViewById(R.id.textView_name_profile_nav);
        textView.setText(bundle.getString(LoginActivity.EXTRA_NAME));

        textView = (TextView)  header.findViewById(R.id.textView_email_profile_nave);
        textView.setText(bundle.getString(LoginActivity.EXTRA_EMAIL));
    }
